...
properties = {
  ...
  probeSlowSpeed: {
    title: "Slow probing speed (mm/min)",
    description: "Slow probing speed (mm/min)",
    type: "number",
    value: 25.0 // mm/min
  },
  probeSlowDistance: {
    title: "Slow probe distance (mm)",
...
var GV_TOL_SIZE = 26;  //the tolerance for the size
...
// As WCS 0 and 1 are the same, force to be 1
    ...
    switch (cycleType) {
      ...
      */
      ...
      case "probing-x":
        ...
        break;
      case "probing-y":
        setMach3Variables(x, y, z, cycleType, 2);
        break;
      case "probing-z":
        setMach3Variables(x, y, z, cycleType, 3);
        break;
      case "probing-x-wall":
        setMach3Variables(x, y, z, cycleType, 4);
        break;
      case "probing-y-wall":
        setMach3Variables(x, y, z, cycleType, 5);
        break;
      case "probing-x-channel":
        setMach3Variables(x, y, z, cycleType, 6);
        break;
      case "probing-x-channel-with-island":
        setMach3Variables(x, y, z, cycleType, 7);
        break;
      case "probing-y-channel":
        setMach3Variables(x, y, z, cycleType, 8);
        break;
      case "probing-y-channel-with-island":
        setMach3Variables(x, y, z, cycleType, 9);
        break;
      case "probing-xy-circular-boss":
        setMach3Variables(x, y, z, cycleType, 10);
        break;
      case "probing-xy-circular-hole":
        setMach3Variables(x, y, z, cycleType, 11);
        break;
      case "probing-xy-circular-hole-with-island":
        setMach3Variables(x, y, z, cycleType, 12);
        break;
      case "probing-xy-rectangular-hole":
        setMach3Variables(x, y, z, cycleType, 13);
        break;
      case "probing-xy-rectangular-boss":
        setMach3Variables(x, y, z, cycleType, 14);
        break;
      case "probing-xy-rectangular-hole-with-island":
        setMach3Variables(x, y, z, cycleType, 15);
        break;
      case "probing-xy-inner-corner":
        setMach3Variables(x, y, z, cycleType, 16);
        break;
      case "probing-xy-outer-corner":
        setMach3Variables(x, y, z, cycleType, 17);
        break;
      case "probing-x-plane-angle":
        setMach3Variables(x, y, z, cycleType, 18);
        break;
      ...
      case "probing-xy-circular-partial-hole":
        setMach3Variables(x, y, z, cycleType, 21);
        break;
      case "probing-xy-circular-partial-hole-with-island":
        setMach3Variables(x, y, z, cycleType, 22);
        break;
      default:
        expandCyclePoint(x, y, z);
...
function setMach3Variables(x, y, z, cycleType, probeTypeNum) {
  ...
  switch (probeTypeNum) {
    ...
    case 21:
    case 22:
      writeBlock(formatSetVar(GV_TOOL_DIA, xyzFormat.format(tool.diameter)));
      writeBlock(formatSetVar(GV_WCS, probe100Format.format(probeOutputWorkOffset)));
      writeBlock(formatSetVar(GV_TOL_POSITION,
        xyzFormat.format((cycle.outOfPositionAction == "stop-message" ? (cycle.tolerancePosition ? cycle.tolerancePosition : 0) : 0))));
      break;
  }
  ...
  switch (probeTypeNum) {
    ...
    case 21:
    case 22:
      writeBlock(formatSetVar(GV_TOL_SIZE,
        xyzFormat.format((cycle.wrongSizeAction == "stop-message" ? (cycle.toleranceSize ? cycle.toleranceSize : 0) : 0))));
      writeBlock(formatSetVar(GV_WIDTH1, xyzFormat.format(cycle.width1)));
      break;
  }
  ...
  switch (probeTypeNum) {
    ...
    case 14:
    case 15:
      writeBlock(formatSetVar(GV_WIDTH2, xyzFormat.format(cycle.width2)));
      break;
  }
  ...
  switch (probeTypeNum) {
    ...
    case 18:
    case 19:
      writeBlock(formatSetVar(GV_TOL_ANGLE,
        xyzFormat.format((cycle.angleAskewAction == "stop-message" ? (cycle.toleranceAngle ? cycle.toleranceAngle : 0) : 0))));
      break;
  }
  ...
  switch (probeTypeNum) {
    ...
    case 18:
    case 19:
      writeBlock(formatSetVar(GV_APPROACH1, approach(cycle.approach1)));
      break;
  }
  ...
  switch (probeTypeNum) {
    case 16:
    case 17:
      writeBlock(formatSetVar(GV_APPROACH2, approach(cycle.approach2)));
      break;
  }
  ...
  switch (probeTypeNum) {
    case 18:
    case 19:
      writeBlock(formatSetVar(GV_PROBE_SPACING, xyzFormat.format(cycle.probeSpacing)));
      break;
  }
  ...
  switch (probeTypeNum) {
    ...
    case 21:
    case 22:
      writeBlock(formatSetVar(GV_PAR_CIRC_ANG_A, probeAngleFormat.format(cycle.partialCircleAngleA)));
      writeBlock(formatSetVar(GV_PAR_CIRC_ANG_B, probeAngleFormat.format(cycle.partialCircleAngleB)));
      writeBlock(formatSetVar(GV_PAR_CIRC_ANG_C, probeAngleFormat.format(cycle.partialCircleAngleC)));
      break;
  }
